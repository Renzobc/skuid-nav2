...
: ${AMENT_CURRENT_PREFIX:="/workspaces/skuid-nav2/install/skuid-nav2-bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/skuid-nav2-bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/skuid-nav2-bringup/environment/path.sh"
